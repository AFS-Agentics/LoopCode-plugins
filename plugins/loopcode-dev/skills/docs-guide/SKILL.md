---
name: loopcode-docs-guide
description: Guidance for writing and editing LoopCode documentation for users and developers, including localized content. Does not cover release notes or code comments.
---
...
Repository-specific details — doc framework, section layout, localization, paths, syntax, and terminology examples — live in `references/project-profile.md`. Read it first and verify changeable details against the current repository. Use `loopcode-dev-guide` for the broader development workflow.
