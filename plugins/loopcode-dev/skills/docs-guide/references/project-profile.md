# Project Profile — LoopCode

This file records LoopCode-specific conventions and examples. Verify them against the current repository before writing; locale support and product terminology can evolve.
...
- UI localization is separate and is covered by `loopcode-dev-guide`.
