---
name: loopcode-dev-guide
description: LoopCode development conventions. Use when changing protocols or shipping user-facing functionality.
---

# LoopCode Development Guide

Project-specific workflow and norms for LoopCode.
